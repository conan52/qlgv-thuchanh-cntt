...
FX.prototype = {
    ...
    kendoStop: function(gotoEnd) {
        ...
        ///     In browsers that don't support transitions falls back to jQuery stop().This functionality is useful to avoid
        ///     chaining many effects, causing them to run longer than expected.
        /// </summary>
    ...
    kendoRemoveClass: function(classes, options) {
        ...
        ///     A list of the classes that should be removed from the element/s, separated by a
        ///     space.
        /// </param>
        /// <param name="options" type="">An object containing several additional options, like duration and exclusive.</param>
    },
    ...
    kendoToggleClass: function(classes, options, toggle) {
        ...
        /// </summary>
        /// <param name="classes" type="String">
        ///     A list of the classes that should be toggled on the element/s, separated by a
        ///     space.
        /// </param>
        /// <param name="options" type="">An object containing several additional options, like duration and exclusive.</param>
        /// <param name="toggle" type="Boolean">
        ///     A boolean flag to control the toggle - true to add or false to remove the CSS
        ///     class. If omitted the method will assume the opposite state should be toggled.
        /// </param>
    },
...
kendo.Layout.prototype = {
    showIn: function(container, view, transitionClass) {
        ...
        /// <param name="transitionClass" type="string">
        ///     Optional. If provided, the new view will replace the current one with a
        ///     replace effect.
        /// </param>
    },
...
kendo.Observable.prototype = {
    bind: function(eventName, handler) {
        ...
        ///     A function to execute each time the event is triggered. That function should have
        ///     a single parameter which will contain any event specific data.
        /// </param>
    },
    ...
    unbind: function(eventName, handler) {
        ...
        ///     The name of the event. If not specified all handlers of all events will be
        ///     removed.
        /// </param>
        /// <param name="handler" type="Function">
        ///     The handler which should no longer be executed. If not specified all handlers
        ///     listening to that event will be removed.
        /// </param>
    },
...
kendo.Router.prototype = {
    ...
    route: function(route, callback) {
        /// <summary>
        ///     Specifies a callback for the given route. The route definition can contain bound parameters, optional segments, and
        ///     route globbing.
        ///     The parsed parts of the URL are passed as parameters to the route callback. Query string parameters are parsed and
        ///     passed as last argument of the callback function.
        /// </summary>
    ...
    replace: function(route, silent) {
        /// <summary>
        ///     Navigates to the given route, replacing the current view in the history stack (like history.replaceState or
...
kendo.View.prototype = {
    destroy: function() {
        /// <summary>
        ///     Removes the View element from the DOM. Detaches all event handlers and removes jQuery.data attributes to avoid
        ///     memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    render: function(container) {
        ...
        ///     Alternatively, the render method can be called without parameters in order to retrieve the View element for manual
        ///     insertion/further manipulation.
        /// </summary>
...
$.fn.kendoView = function(options) {
    ...
    ///     &#10;If set to false, the view will not wrap its contents in a root element. In that case, the view element will
    ///     point to the root element in the template. If false, the view template should have a single root element.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.data.Binder.prototype = {
    refresh: function() {
        /// <summary>
        ///     Invoked by the Kendo UI MVVM framework when the bound view model value is changed. The binder should update the UI
        ///     (HTML element or Kendo UI widget) to reflect the view model change.
        /// </summary>
    },
...
kendo.data.DataSource.prototype = {
    add: function(model) {
        ...
        ///     Either a kendo.data.Model instance or JavaScript object containing the data item
        ///     field values.
        /// </param>
    ...
    at: function(index) {
        ...
        /// <returns type="kendo.data.ObservableObject">
        ///     the data item at the specified index. Returns undefined if a data item is
        ///     not found at the specified index.Returns a kendo.data.Model instance if the schema.model option is set.
        /// </returns>
    },
    ...
    cancelChanges: function(model) {
        /// <summary>
        ///     Cancels any pending changes in the data source. Deleted data items are restored, new data items are removed and
        ///     updated data items are restored to their initial state.
        /// </summary>
        /// <param name="model" type="kendo.data.Model">
        ///     The optional data item (model). If specified only the changes of this data
        ///     item will be discarded. If omitted all changes will be discarded.
        /// </param>
    },
    ...
    data: function(value) {
        /// <summary>
        ///     Gets or sets the data items of the data source.If the data source is bound to a remote service (via the transport
        ///     option) the data method will return the service response.
        ///     Every item from the response is wrapped in a kendo.data.ObservableObject or kendo.data.Model (if the schema.model
        ///     option is set).If the data source is bound to a JavaScript array (via the data option) the data method will return
        ///     the items of that array.
        ///     Every item from the array is wrapped in a kendo.data.ObservableObject or kendo.data.Model (if the schema.model
        ///     option is set).If the data source is grouped (via the group option or the group method) and the serverGrouping is
        ///     set to true
        ///     the data method will return the group items.
        /// </summary>
        /// <param name="value" type="Object">
        ///     The data items which will replace the current ones in the data source. If omitted the
        ///     current data items will be returned.
        /// </param>
        /// <returns type="kendo.data.ObservableArray">
        ///     the data items of the data source. Returns empty array if the data source
        ///     hasn't been populated with data items via the read, fetch or query methods.
        /// </returns>
    },
    ...
    fetch: function(callback) {
        /// <summary>
        ///     Reads the data items from a remote service (if the transport option is set) or from a JavaScript array (if the data
        ///     option is set).
        /// </summary>
        /// <param name="callback" type="Function">
        ///     The optional function which is executed when the remote request is finished.
        ///     The function context (available via the this keyword) will be set to the data source instance.
        /// </param>
    },
    ...
    filter: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Object">
        ///     The filter configuration. Accepts the same values as the filter option (check there
        ///     fo more examples).
        /// </param>
    ...
    getByUid: function(uid) {
        ...
        /// <returns type="kendo.data.ObservableObject">
        ///     the model instance. Returns undefined if a model with the specified uid is
        ///     not found.
        /// </returns>
    },
    ...
    pushCreate: function(items) {
        /// <summary>
        ///     Appends the specified data item(s) to the data source without marking them as "new". The data source will not sync
        ///     data items appended via pushCreate.
        /// </summary>
    ...
    pushDestroy: function(items) {
        /// <summary>
        ///     Removes the specified data item(s) from the data source without marking them as "removed". The data source will not
        ///     sync data items appended via pushDestroy.
        /// </summary>
    ...
    pushUpdate: function(items) {
        /// <summary>
        ///     Updates the specified data item(s) without marking them as "dirty". The data source will not sync data items
        ///     appended via pushUpdate.
    ...
    read: function(data) {
        /// <summary>
        ///     Reads data items from a remote service (if the transport option is set) or from a JavaScript array (if the data
        ///     option is set).
        /// </summary>
    ...
    total: function() {
        ...
        /// </summary>
        /// <returns type="Number">
        ///     the total number of data items. Returns the length of the array returned by the data method if
        ///     schema.total or transport.read are not set.Returns 0 if the data source hasn't been populated with data items via
        ///     the read, fetch or query methods.
        /// </returns>
    },
    ...
    view: function() {
        /// <summary>
        ///     Returns the data items which correspond to the current page, filter, sort and group configuration.To ensure that
        ///     data is available this method should be used within the change event handler or the fetch method.
        /// </summary>
        /// <returns type="kendo.data.ObservableArray">
        ///     the data items. Returns groups if the data items are grouped (via the group
        ///     option or the group method).
        /// </returns>
    },
...
$.fn.kendoDataSource = function(options) {
    ...
    ///     &#10;
    ///     &#10;aggregate — Array
    ///     &#10;The aggregate(s) which are calculated when the data source populates with data. The supported aggregates are
    ...
    ///     cause one HTTP request instead of two. By default the data source
    ///     &#10;makes a HTTP request for every CRUD operation.
    ///     &#10;
    ///     &#10;data — Array|String
    ///     &#10;The array of data items which the data source contains. The data source will wrap those items as
    ///     kendo.data.ObservableObject or kendo.data.Model (if schema.model is set).Can be set to a string value if the
    ///     schema.type option is set to "xml".
    ///     &#10;
    ///     &#10;filter — Array|Object
    ...
    ///     data source performs filtering client-side.By default the filter is sent to the server following jQuery's
    ///     conventions.For example the filter { logic: "and", filters: [ { field: "name", operator: "startswith", value:
    ///     "Jane" } ] } is sent as:Use the parameterMap option to send the filter option in a different format.
    ///     &#10;
    ...
    ///     data source performs grouping client-side.By default the group is sent to the server following jQuery's
    ///     conventions.For example the group { field: "category", dir: "desc" } is sent as:Use the parameterMap option to send
    ///     the group option in a different format.
    ///     &#10;
    ///     &#10;serverPaging — Boolean (default: false)
    ///     &#10;If set to true the data source will leave the data item paging implementation to the remote service. By
    ///     default the data source performs paging client-side.The following options are sent to the server when server paging
    ///     is enabled:Use the parameterMap option to send the paging options in a different format.
    ///     &#10;
    ...
    ///     default the data source performs sorting client-side.By default the sort is sent to the server following jQuery's
    ///     conventions.For example the sort { field: "age", dir: "desc" } is sent as:Use the parameterMap option to send the
    ///     paging options in a different format.
    ///     &#10;
    ///     &#10;sort — Array|Object
    ///     &#10;The sort order which will be applied over the data items. By default the data items are not sorted.
    ///     &#10;
    ///     &#10;transport — Object
    ///     &#10;The configuration used to load and save the data items. A data source is remote or local based on the way of
    ///     it retrieves data items.Remote data sources load and save data items from and to a remote end-point (a.k.a. remote
    ///     service or server). The transport option describes the remote service configuration - URL, HTTP verb, HTTP headers
    ///     etc.
    ///     &#10;The transport option can also be used to implement custom data loading and saving.Local data sources are bound
    ///     to a JavaScript array via the data option.
    ///     &#10;
    ///     &#10;type — String
...
kendo.data.Model.prototype = {
    bind: function() {
        /// <summary>
        ///     Attaches a handler to an event. Examples and more info can be found in the bind section of the kendo.Observable API
        ///     reference.
        /// </summary>
    },
    ...
    get: function() {
        /// <summary>
        ///     Gets the value of the specified field. Inherited from kendo.data.ObservableObject. Examples and more info can be
        ///     found in the get section of the
    ...
    isNew: function() {
        ...
        ///     If the value of the field specified is equal to the default value (specified through the fields configuration) the
    ...
    set: function() {
        /// <summary>
        ///     Sets the value of the specified field. Inherited from kendo.data.ObservableObject. Examples and more info can be
        ///     found in the set section of the
        ///     ObservableObject API reference.
        /// </summary>
    },
    ...
    toJSON: function() {
        /// <summary>
        ///     Creates a plain JavaScript object which contains all fields of the Model. Inherited from
        ///     kendo.data.ObservableObject. Examples and more info can be found in the toJSON section of the
        ///     ObservableObject API reference.
        /// </summary>
    },
...
kendo.data.ObservableArray.prototype = {
    ...
    parent: function() {
        ...
        /// </summary>
        /// <returns type="kendo.data.ObservableObject">
        ///     the parent of the array; undefined if the array is not nested and doesn't
        ///     have a parent.
        /// </returns>
    },
    ...
    splice: function(index, howMany) {
        ...
        ///     An integer indicating the number of items to remove. If set to 0, no items are
        ///     removed. In this case, you should specify at least one new item.
        /// </param>
        /// <returns type="Array">
        ///     containing the removed items. The result of the splice method is not an instance of
        ///     ObvservableArray.
        /// </returns>
    },
    ...
    unshift: function() {
        /// <summary>
        ///     Adds one or more items to the beginning of an ObservableArray and returns the new length.  Equivalent of
...
kendo.data.ObservableObject.prototype = {
    ...
    parent: function() {
        ...
        /// </summary>
        /// <returns type="kendo.data.ObservableObject">
        ///     the parent of the object; undefined if the object is not nested and doesn't
        ///     have a parent.
        /// </returns>
    },
...
kendo.data.SchedulerEvent.prototype = {
    ...
    toOccurrence: function(options) {
        /// <summary>
        ///     Converts the scheduler event to a event occurrence. Method will remove recurrenceRule, recurrenceException options,
        ///     will add a recurrenceId field and will set id to the default one.
        /// </summary>
        /// <param name="options" type="Object">Additional options passed to the SchedulerEvent constructor.</param>
...
$.fn.kendoSchedulerEvent = function(options) {
    ...
    ///     &#10;The timezone of the end date. If not specified the timezone will be used.The complete list of the supported
    ///     timezones is available in the List of IANA time zones Wikipedia page.
    ///     &#10;
    ...
    ///     &#10;The recurrence exceptions. A list of semicolon separated dates formatted using the yyyyMMddTHHmmssZ format
    ///     string.
    ///     &#10;
    ...
    ///     &#10;The timezone of the start date. If not specified the timezone will be used.The complete list of the supported
    ///     timezones is available in the List of IANA time zones Wikipedia page.
    ///     &#10;
...
kendo.dataviz.ui.Barcode.prototype = {
    imageDataURL: function() {
        ...
        /// </summary>
        /// <returns type="String">
        ///     A data URL with image/png MIME type. Will be null if the browser does not support the canvas
        ///     element.
        /// </returns>
    },
    ...
    svg: function() {
        /// <summary>
        ///     Returns the SVG representation of the barcode. The returned string is a self-contained SVG document that can be
        ///     used as is or converted to other formats using tools like Inkscape and
...
$.fn.kendoBarcode = function(options) {
    ...
    ///     &#10;If it is not supported by the browser, the Barcode will switch to the first available mode.The supported
    ///     values are:
    ///     &#10;
...
kendo.dataviz.ui.Chart.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the widget for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoChart = function(options) {
    ...
    ///     &#10;If set to false the widget will not bind to the data source during initialization. In this case data binding
    ///     will occur when the change event of the
    ///     &#10;data source is fired. By default the widget will bind to the data source specified in the configuration.
    ///     &#10;
    ///     &#10;axisDefaults — Object
    ///     &#10;The default options for all chart axes. Accepts the options supported by categoryAxis, valueAxis, xAxis and
    ///     yAxis.
    ///     &#10;
    ...
    ///     &#10;The data source of the chart which is used to display the series. Can be a JavaScript object which represents
    ///     a valid data source configuration, a JavaScript array or an existing kendo.data.DataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;legend — Object
    ///     &#10;The chart legend configuration options.
    ///     &#10;
    ///     &#10;panes — Array
    ///     &#10;The chart panes configuration.Panes are used to split the chart in two or more parts. The panes are ordered
    ///     from top to bottom.Each axis can be associated with a pane by setting its pane option to the name of the desired
    ///     pane.
    ///     &#10;Axis that don't have specified pane are placed in the top (default) pane.Series are moved to the desired pane
    ///     by associating them with an axis.
    ///     &#10;
    ///     &#10;plotArea — Object
    ...
    ///     &#10;renderAs — String
    ///     &#10;Sets the preferred rendering engine.
    ///     &#10;If it is not supported by the browser, the Chart will switch to the first available mode.The supported values
    ///     are:
    ///     &#10;
    ///     &#10;series — Array
...
kendo.dataviz.ui.Diagram.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the widget for safe removal from the DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    viewToModel: function(point) {
        /// <summary>
        ///     Transforms a point from View coordinates to Model coordinates. Model coordinates are independent coordinates to
        ///     define Shape bounds.
        /// </summary>
        /// <param name="point" type="Object">The point in View coordinates.</param>
        /// <returns type="Object">the transformed point</returns>
    ...
    modelToView: function(point) {
        /// <summary>
        ///     Transforms a point from Model coordinates to View coordinates. Model coordinates are independent coordinates to
        ///     define Shape bounds.
        /// </summary>
    ...
    modelToLayer: function(point) {
        /// <summary>
        ///     Transforms a point from Model coordinates to Layer coordinates. Layer coordinates are relative to the drawing
        ///     surface.
        /// </summary>
        /// <param name="point" type="Object">The point in Model coordinates.</param>
        /// <returns type="Object">the transformed point</returns>
    ...
    layerToModel: function(point) {
        /// <summary>
        ///     Transforms a point from Layer coordinates to Model coordinates. Layer coordinates are relative to the drawable
        ///     surface.
        /// </summary>
    ...
    documentToModel: function(point) {
        /// <summary>
        ///     Transforms a point from Page document coordinates to Model coordinates. Shortcut for
        ///     viewToModel(documentToView(point))
        /// </summary>
        /// <param name="point" type="Object">The point in Page document coordinates.</param>
        /// <returns type="Object">the transformed point</returns>
    },
    ...
    modelToDocument: function(point) {
        /// <summary>
        ///     Transforms a point from Model coordinates to Page document coordinates. Shortcut for
        ///     viewToDocument(modelToView(point))
        /// </summary>
        /// <param name="point" type="Object">The point in Model coordinates.</param>
        /// <returns type="Object">the transformed point</returns>
    },
    ...
    connect: function(source, target, options) {
        /// <summary>
        ///     Creates a connection which can be either attached on both ends to a shape, half attached or floating (not attached
        ///     to any shape). When a connection is (half) attached to a shape it happens through the intermediate Connector
        ///     object. Connectors are part of a Shape's definition and you can specify the binding of a connection to a shape
        ///     directly via the shape or via one of its connectors. If you specify a Shape as a connection's endpoint the
        ///     Auto-connector will be used. This means that the endpoint of the connection will switch to the most convenient (in
        ///     the sense of shortest path) connector automatically. If you specify a shape's connector as an endpoint for a
        ///     connection the endpoint will remain attached to that given Connector instance.
        ///     Finally, if you wish to have a (half) floating connection endpoint you should specify a Point as parameter for the
        ///     floating end.
        /// </summary>
        /// <param name="source" type="Object">
        ///     The source definition of the connection. This can be a Shape, a Connector or a
        ///     Point.
        /// </param>
        /// <param name="target" type="Object">
        ///     The target definition of the connection. This can be a Shape, a Connector or a
        ///     Point.
        /// </param>
    ...
    select: function(obj, options) {
        /// <summary>
        ///     Gets the currently selected items is no parameter is specified. If a parameter is specified this selects items in
        ///     the diagram on the basis of the given input.
        /// </summary>
        /// <param name="obj" type="Object"></param>
        /// <param name="options" type="Object">
        ///     Only one Boolean option is currently defined; addToSelection. If set to true the
        ///     newly selected items will be added to the existing selection. Otherwise a new selection set is created. The default
        ///     is false.
        /// </param>
    },
    ...
    toFront: function(items, undoable) {
        /// <summary>
        ///     Brings the specified items in front, i.e. it's reordering items to ensure they are on top of the complementary
        ///     items.
        /// </summary>
    ...
    toBack: function(items, undoable) {
        /// <summary>
        ///     Sends the specified items to the back, i.e. it's reordering items to ensure they are underneath the complementary
        ///     items.
        /// </summary>
        /// <param name="items" type="Array">An array of diagram items.</param>
        /// <param name="undoable" type="Boolean">Whether the change should be recorded in the undo-redo stack.</param>
    ...
    boundingBox: function(items) {
        ...
        ///     The items (shapes and connections) to include in the bounding box. Defaults to all
        ///     items if not specified.
        /// </param>
        /// <returns type="kendo.dataviz.diagram.Rect">
        ///     The bounding rectangle of the specified items. If nothing is specified the
        ///     bounding box of the all diagram will be returned.
        /// </returns>
    },
    ...
    layout: function(options) {
        /// <summary>
        ///     Applies a layout algorithm on the current diagram.A more detailed overview of layout and graph analysis can be
        ///     found below.
        /// </summary>
...
$.fn.kendoDiagram = function(options) {
    ...
    ///     &#10;
    ///     &#10;layout — Object
    ///     &#10;The layout of a diagram consists in arranging the shapes (sometimes also the connections) in some fashion in
    ///     order to achieve an aesthetically pleasing experience to the user. It aims at giving a more direct insight in the
    ///     information contained within the diagram and its relational structure.On a technical level, layout consists of a
    ///     multitude of algorithms and optimizations:and various ad-hoc calculations which depend on the type of layout. The
    ///     criteria on which an algorithm is based vary but the common denominator is:Kendo diagram includes three of the most
    ///     used layout algorithms which should cover most of your layout needs - tree layout, force-directed layout and
    ///     layered layout. Please, check the type property for more details regarding each type.The generic way to apply a
    ///     layout is by calling the layout() method on the diagram. The method has a single parameter options. It is an
    ///     object, which can contain parameters which are specific to the layout as well as parameters customizing the global
    ///     grid layout. Parameters which apply to other layout algorithms can be included but are overlooked if not applicable
    ///     to the chose layout type. This means that you can define a set of parameters which cover all possible layout types
    ///     and simply pass it in the method whatever the layout define in the first parameter.
    ///     &#10;
    ///     &#10;template — String|Function (default: "")
    ///     &#10;The template which renders the content of the shape when bound to a dataSource. The names you can use in the
    ///     template correspond to the properties used in the dataSource. See the dataSource topic below for a concrete
    ///     example.
    ///     &#10;
    ///     &#10;resizable — Boolean (default: true)
    ///     &#10;This defines whether the shapes can be resized. If set to false the adorner will not show the resizing thumbs,
    ///     as can be seen below;
    ///     &#10;
    ///     &#10;rotatable — Boolean (default: true)
    ///     &#10;This defines whether the shapes can be rotated. If set to false the adorner will not show the rotating thumb,
    ///     as can be seen below;
    ///     &#10;
...
$.fn.kendoLinearGauge = function(options) {
    ...
    ///     &#10;renderAs — String
    ///     &#10;Sets the preferred rendering engine.
    ///     &#10;If it is not supported by the browser, the Gauge will switch to the first available mode.The supported values
    ///     are:
    ///     &#10;
    ///     &#10;scale — Object
...
kendo.dataviz.ui.Map.prototype = {
    center: function(center) {
        ...
        ///     The location of the new map center. An array argument is assumed to be in [Latitude,
        ///     Lonigude] order.
        /// </param>
    ...
    eventToView: function(e) {
        ...
        ///     Layer elements positioned on these coordinates will appear under the mouse cursor.View coordinates are no longer
        ///     valid after a map reset.
        /// </summary>
        /// <param name="e" type="Object">The DOM or jQuery mouse event.</param>
    ...
    locationToLayer: function(location, zoom) {
        ...
        ///     The geographic location. An array argument is assumed to be in [Latitude,
        ///     Lonigude] order.
        /// </param>
        /// <param name="zoom" type="Number">Optional. Assumed zoom level. Defaults to the current zoom level.</param>
...
$.fn.kendoMap = function(options) {
    ...
    ///     &#10;The initial zoom level.Typical web maps use zoom levels from 0 (whole world) to 19 (sub-meter features).The
    ///     map size is derived from the zoom level and minScale options: size = (2 ^ zoom) * minSize
    ///     &#10;
...
kendo.dataviz.ui.QRCode.prototype = {
    ...
    svg: function() {
        /// <summary>
        ///     Returns the SVG representation of the qrcode. The returned string is a self-contained SVG document that can be used
        ///     as is or converted to other formats using tools like Inkscape and
        ///     ImageMagick. Both programs provide command-line interface suitable for server-side processing.
        /// </summary>
...
$.fn.kendoQRCode = function(options) {
    ...
    ///     &#10;renderAs — String (default: "canvas")
    ///     &#10;Sets the preferred rendering engine.
    ///     &#10;If it is not supported by the browser, the QRCode will switch to the first available mode.The supported values
    ///     are:
    ///     &#10;
    ///     &#10;size — Number|String
    ///     &#10;Specifies the size of a QR code in pixels (i.e. "200px"). Numeric values are treated as pixels. If no size is
    ///     specified, it will be determined from the element width and height. In case the element does not have width or
    ///     height bigger than zero, a default value of 200 pixels will be used.
    ///     &#10;
    ///     &#10;value — Number|String
...
kendo.dataviz.ui.Sparkline.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the Sparkline for safe removal from the DOM.Detaches event handlers and removes data entries in order to
        ///     avoid memory leaks.
        /// </summary>
    },
...
$.fn.kendoSparkline = function(options) {
    ...
    ///     &#10;renderAs — String
    ///     &#10;Sets the preferred rendering engine.
    ///     &#10;If it is not supported by the browser, the Sparkline will switch to the first available mode.The supported
    ///     values are:
    ///     &#10;
    ///     &#10;series — Array
...
kendo.mobile.Application.prototype = {
    ...
    navigate: function(url, transition) {
        ...
        ///     Optional. The transition to apply when navigating. See View Transitions section
    ...
    skin: function(skin) {
        /// <summary>
        ///     Change the current skin of the mobile application. When used without parameters, returns the currently used skin.
        ///     Available as of Q2 2013.
        /// </summary>
...
$.fn.kendoMobileApplication = function(options) {
    ...
    ///     &#10;Whether to hide the browser address bar. Supported only in iPhone and iPod. Doesn't affect standalone mode as
    ///     there the address bar is always hidden.
    ///     &#10;
    ...
    ///     &#10;The text displayed in the loading popup. Setting this value to false will disable the loading popup.Note: The
    ///     text should be wrapped inside  tag.
    ///     &#10;
    ///     &#10;platform — String
    ///     &#10;Which platform look to force on the application. Supported values are "ios" (meaning iOS 6 look),
    ///     "ios7","android", "blackberry" and "wp".
    ///     &#10;You can also set platform variants with it ("android-light" or "android-dark"), but keep in mind that it will
    ///     still override the platform. If this is not desired, use the skin option.
    ///     &#10;
    ///     &#10;serverNavigation — Boolean
    ///     &#10;If set to true, the application will not use AJAX to load remote views.
    ///     &#10;
    ///     &#10;skin — String
    ///     &#10;The skin to apply to the application. Currently, Kendo UI Mobile ships with a flat skin in addition to the
    ///     native looking ones. You can also set platform variants with it ("android-light" or "android-dark").
    ///     &#10;
    ///     &#10;statusBarStyle — String (default: "black")
    ///     &#10;Set the status bar style meta tag in iOS used to control the styling of the status bar in a pinned to the Home
    ///     Screen app. Available as of Q2 2013 SP.
    ///     &#10;
    ///     &#10;transition — String
    ///     &#10;The default View transition.
    ///     &#10;
    ///     &#10;webAppCapable — Boolean
    ///     &#10;Disables the default behavior of Kendo UI Mobile apps to be web app capable (open in a chromeless browser).
    ///     Introduced in Q2 2013.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.mobile.ui.ActionSheet.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ActionSheet for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    open: function(target, context) {
        ...
        ///     (optional) The target element of the ActionSheet, available in the callback
        ///     methods.Notice The target element is mandatory on tablets, as the ActionSheet widget positions itself relative to
        ///     opening element when a tablet is detected.
        /// </param>
...
$.fn.kendoMobileActionSheet = function(options) {
    ...
    ///     &#10;By default, the actionsheet opens as a full screen dialog on a phone device or as a popover if a tablet is
    ///     detected. Setting the type to "phone" or "tablet" will force the looks of the widget regardless of the device.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.mobile.ui.BackButton.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the BackButton for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.mobile.ui.Button.prototype = {
    badge: function(value) {
        /// <summary>
        ///     Introduced in Q1 2013 SP Sets a badge on the Button with the specified value. If invoked without parameters,
        ///     returns the current badge value. Set the value to false to remove the badge.
        /// </summary>
        /// <param name="value" type="Object">The target value to be set or false to be removed.</param>
        /// <returns type="String | kendo.mobile.ui.Button">
        ///     the badge value if invoked without parameters, otherwise the Button
        ///     object.
        /// </returns>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Button for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMobileButton = function(options) {
    ...
    ///     &#10;If set to false the widget will be disabled and will not allow the user to click it. The widget is enabled by
    ///     default.
    ///     &#10;
    ///     &#10;icon — String
...
kendo.mobile.ui.ButtonGroup.prototype = {
    badge: function(button, value) {
        /// <summary>
        ///     Introduced in Q1 2013 SP Sets a badge on one of the ButtonGroup buttons with the specified value. If invoked
        ///     without parameters, returns the button's current badge value. Set the value to false to remove the badge.
        /// </summary>
        /// <param name="button" type="Object">
        ///     The target button specified either as a jQuery selector/object or as an button
        ///     index.
        /// </param>
        /// <param name="value" type="Object">The target value to be set or false to be removed.</param>
        /// <returns type="String|kendo.mobile.ui.Button">
        ///     the badge value if invoked without parameters, otherwise the ButtonGroup
        ///     object.
        /// </returns>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ButtonGroup for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMobileButtonGroup = function(options) {
    ...
    ///     &#10;Sets the DOM event used to select the button. Accepts "up" as an alias for touchend, mouseup and MSPointerUp
    ///     vendor specific events.By default, buttons are selected immediately after the user presses the button (on
    ///     touchstart or mousedown or MSPointerDown, depending on the mobile device).
    ///     &#10;However, if the widget is placed in a scrollable view, the user may accidentally press the button when
    ///     scrolling. In such cases, it is recommended to set this option to "up".
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.mobile.ui.DetailButton.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the DetailButton for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.mobile.ui.Drawer.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the Drawer for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMobileDrawer = function(options) {
    ...
    ///     &#10;If set to false, swiping the view will not activate the drawer. In this case, the drawer will only be open by
    ///     a designated button
    ///     &#10;
    ///     &#10;title — String
    ...
    ///     &#10;
    ///     &#10;views — Array
    ///     &#10;A list of the view ids on which the drawer will appear. If omitted, the drawer will work on any view in the
    ///     application.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
...
kendo.mobile.ui.ListView.prototype = {
    append: function(dataItems) {
        /// <summary>
        ///     Appends new items generated by rendering the given data items with the listview template to the bottom of the
        ///     listview.
        /// </summary>
    ...
    prepend: function(dataItems) {
        /// <summary>
        ///     Prepends new items generated by rendering the given data items with the listview template to the top of the
        ///     listview.
        /// </summary>
        /// <param name="dataItems" type="Array"></param>
    },
    ...
    setDataItem: function(item, dataItem) {
        /// <summary>
        ///     Re-renders the given listview item with the new dataItem provided. In order for the method to work as expected, the
        ///     data items should be of type kendo.data.Model.
        /// </summary>
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ListView for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMobileListView = function(options) {
    ...
    ///     &#10;
    ///     &#10;autoBind — Boolean (default: true)
    ///     &#10;Indicates whether the listview will call read on the DataSource initially. If set to false, the listview will
    ///     be bound after the DataSource instance fetch method is called.
    ///     &#10;
    ///     &#10;dataSource — Object
    ...
    ///     &#10;Applicable only when the type is set to group, or when binding to grouped DataSource.Notice: fixed headers are
    ...
    ///     &#10;If set to true, a button is rendered at the bottom of the listview. Tapping it fetches and displays the items
    ///     from the next page of the DataSource.
    ///     &#10;
    ...
    ///     &#10;A callback function used when the 'pullToRefresh' option is enabled. The result of the function will be send
    ///     as additional parameters to the DataSource's next method.Notice: When the listview is in a virtual mode, the pull
    ///     to refresh action removes the previously loaded items in the listview (instead of appending new records at the
    ///     top).
...
kendo.mobile.ui.ModalView.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ModalView for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.mobile.ui.NavBar.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the NavBar for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.mobile.ui.Pane.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the Pane for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    navigate: function(url, transition) {
        ...
        /// <param name="url" type="String">The id or URL of the view.</param>
        /// <param name="transition" type="String">
        ///     The transition to apply when navigating. See View Transitions for more
        ///     information.
        /// </param>
    },
...
$.fn.kendoMobilePane = function(options) {
    ...
    ///     &#10;Applicable when the pane is inside a SplitView. If set to true, the pane will be hidden when the device is in
    ///     portrait position. The expandPanes SplitView method displays the hidden panes.The id of the initial mobile View to
    ///     display.
    ///     &#10;
    ///     &#10;initial — String
    ///     &#10;The id of the initial mobile View to display.
...
kendo.mobile.ui.PopOver.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the PopOver for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    open: function(target) {
        ...
        /// </summary>
        /// <param name="target" type="jQuery">
        ///     The target of the Popover, to which the visual arrow will point to. This parameter
        ///     is required for a tablet OS.
        /// </param>
    },
...
kendo.mobile.ui.ScrollView.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ScrollView for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    scrollTo: function(page, instant) {
        ...
        ///     If set to true, the ScrollView will jump instantly to the given page without any
        ///     animation effects.
        /// </param>
    },
...
$.fn.kendoMobileScrollView = function(options) {
    ...
    ///     &#10;
    ///     &#10;autoBind — Boolean (default: true)
    ///     &#10;If set to false the widget will not bind to the DataSource during initialization. In this case data binding
    ///     will occur when the change event of the data source is fired. By default the widget will bind to the DataSource
    ///     specified in the configuration.Applicable only in data bound mode.
    ///     &#10;
    ///     &#10;bounceVelocityThreshold — Number (default: 1.6)
    ///     &#10;The velocity threshold after which a swipe will result in a bounce effect.
    ///     &#10;
    ///     &#10;contentHeight — Number|String (default: "auto")
    ///     &#10;The height of the ScrollView content. Supports 100% if the ScrollView is embedded in a stretched view and the
    ///     ScrollView element is an immediate child of the view element.
    ///     &#10;
    ///     &#10;dataSource — Object
    ///     &#10;Instance of DataSource that the mobile ScrollView will be bound to. If DataSource is set, the widget will
    ///     operate in data bound mode.
    ///     &#10;
    ///     &#10;duration — Number (default: 400)
    ///     &#10;The milliseconds that take the ScrollView to snap to the current page after released.
    ///     &#10;
    ///     &#10;emptyTemplate — String (default: "")
    ///     &#10;The template which is used to render the pages without content. By default the ScrollView renders a blank
    ///     page.Applicable only in data bound mode.
    ///     &#10;
    ...
    ///     &#10;Multiplier applied to the snap amount of the ScrollView. By default, the widget scrolls to the next screen
    ///     when swipe. If the pageSize property is set to 0.5, the ScrollView will scroll by half of the widget width.Not
    ///     applicable in data bound mode.
    ///     &#10;
    ///     &#10;template — String (default: "#:data#")
    ///     &#10;The template which is used to render the content of pages. By default the ScrollView renders a div element for
    ///     every page.Applicable only in data bound mode.
    ///     &#10;
...
kendo.mobile.ui.Scroller.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Scroller for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMobileScroller = function(options) {
    ...
    ///     &#10;The message template displayed when the user pulls the scroller below the pullOffset, indicating that
    ///     pullToRefresh will occur.
    ///     &#10;Has effect only when the pullToRefresh option is set to true.
    ///     &#10;
    ///     &#10;useNative — Boolean (default: false)
    ///     &#10;If set to true, the scroller will use the native scrolling available in the current platform. This should help
    ///     with form issues on some platforms (namely Android and WP8).
    ///     &#10;Native scrolling is only enabled on platforms that support it: iOS > 4, Android > 2, WP8. BlackBerry devices
    ///     do support it, but the native scroller is flaky.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.mobile.ui.SplitView.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the SplitView for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    collapsePanes: function() {
        /// <summary>
        ///     Collapses back the collapsible panes (displayed previously with expandPanes); has effect only when the device is in
...
kendo.mobile.ui.Switch.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Switch for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    refresh: function() {
        /// <summary>
        ///     Forces the Switch to recalculate its dimensions. Useful when major changes in the interface happen dynamically,
        ///     like for instance changing the skin.
        /// </summary>
    },
...
$.fn.kendoMobileSwitch = function(options) {
    ...
    ///     &#10;
    ///     &#10;enable — Boolean (default: true)
    ///     &#10;If set to false the widget will be disabled and will not allow the user to change its checked state. The
...
kendo.mobile.ui.TabStrip.prototype = {
    badge: function(tab, value) {
        /// <summary>
        ///     Introduced in Q1 2013 SP Sets a badge on one of the tabs with the specified value. If invoked without second
        ///     parameter, returns the tab's current badge value. Set the value to false to remove the badge.
        /// </summary>
        /// <param name="tab" type="Object">The target tab specified either as a jQuery selector/object or as an item index.</param>
        /// <param name="value" type="Object">The target value to be set or false to be removed.</param>
        /// <returns type="String|kendo.mobile.ui.TabStrip">
        ///     Returns the badge value if invoked without parameters, otherwise
        ///     returns the TabStrip object.
        /// </returns>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the TabStrip for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    switchTo: function(url) {
        /// <summary>
        ///     Set the mobile TabStrip active tab to the tab with the specified URL. This method doesn't change the current View.
        ///     To change the View, use Application's navigate method instead.
        /// </summary>
    ...
    switchByFullUrl: function(url) {
        /// <summary>
        ///     Set the mobile TabStrip active tab to the tab with the specified full URL. This method doesn't change the current
        ///     View. To change the View, use Application's navigate method instead.
        /// </summary>
...
kendo.mobile.ui.View.prototype = {
    contentElement: function() {
        /// <summary>
        ///     Retrieves the current content holder of the View - this is the content element if the View is stretched or the
        ///     scroll container otherwise.
        /// </summary>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the View for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    enable: function(enable) {
        ...
        ///     Omitting the parameter or passing true enables the view. Passing false disables the
        ///     view.
        /// </param>
    },
...
$.fn.kendoMobileView = function(options) {
    ...
    ///     &#10;The MVVM model to bind to. If a string is passed, The view will try to resolve a reference to the view model
    ///     variable in the global scope.
    ///     &#10;
    ///     &#10;reload — Boolean (default: false)
    ///     &#10;Applicable to remote views only. If set to true, the remote view contents will be reloaded from the server
    ///     (using Ajax) each time the view is navigated to.
    ///     &#10;
    ...
    ///     &#10;If set to true, the view will use the native scrolling available in the current platform. This should help
    ///     with form issues on some platforms (namely Android and WP8).
    ///     &#10;Native scrolling is only enabled on platforms that support it: iOS > 5+, Android > 3+, WP8. BlackBerry devices
    ///     do support it, but the native scroller is flaky.
    ///     &#10;
    ///     &#10;zoom — Boolean (default: false)
...
kendo.mobile.ui.Widget.prototype = {
    view: function() {
        /// <summary>
        ///     Returns the kendo.mobile.ui.View which contains the widget. If the widget is contained in a splitview, modalview,
        ///     or drawer, the respective widget instance is returned.
        /// </summary>
    },
...
kendo.ui.AutoComplete.prototype = {
    ...
    enable: function(enable) {
        ...
        /// </summary>
        /// <param name="enable" type="Boolean">
        ///     If set to true the widget will be enabled. If set to false the widget will be
        ///     disabled.
        /// </param>
    },
    ...
    readonly: function(readonly) {
        ...
        ///     If set to true the widget will not allow user input. If set to false the widget
    ...
    select: function(item) {
        ...
        ///     A string, DOM element or jQuery object which represents the item to be selected. A
        ///     string is treated as a jQuery selector.
        /// </param>
    },
...
$.fn.kendoAutoComplete = function(options) {
    ...
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used to display suggestions for the current value. Can be a JavaScript
    ///     object which represents a valid data source configuration, a JavaScript array or an existing kendo.data.DataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;dataTextField — String (default: null)
    ///     &#10;The field of the data item used when searching for suggestions.  This is the text that will be displayed in
    ...
    ///     &#10;
    ///     &#10;enable — Boolean (default: true)
    ///     &#10;If set to false the widget will be disabled and will not allow user input. The widget is enabled by default
    ///     and allows user input.
    ///     &#10;
    ///     &#10;filter — String (default: "startswith")
    ///     &#10;The filtering method used to determine the suggestions for the current value. The default filter is
    ///     "startswith" -
    ///     &#10;all data items which begin with the current widget value are displayed in the suggestion popup. The supported
    ///     filter values are startswith, endswith and contains.
    ///     &#10;
    ...
    ///     &#10;If set to false case-sensitive search will be performed to find suggestions. The widget performs
    ...
    ///     &#10;The template used to render the suggestions. By default the widget displays only the text of the suggestion
    ///     (configured via dataTextField).
    ///     &#10;
    ///     &#10;valuePrimitive — Boolean (default: false)
    ///     &#10;Spcifies the value binding behavior for the widget when the initial model value is null. If set to true, the
    ///     View-Model field will be updated with the selected item text field. If set to false, the View-Model field will be
...
kendo.ui.Button.prototype = {
    enable: function(toggle) {
        ...
        /// </summary>
        /// <param name="toggle" type="Boolean">
        ///     Indicates whether the Button should be enabled or disabled. Truthy and falsy
        ///     arguments are accepted. If no argument is supplied, the Button will assume true and will be enabled.
        /// </param>
    },
...
$.fn.kendoButton = function(options) {
    ...
    ///     &#10;
    ///     &#10;enable — Boolean (default: true)
    ///     &#10;Indicates whether the Button should be enabled or disabled. By default, it is enabled, unless a
    ///     disabled="disabled" attribute is detected.
    ///     &#10;
    ///     &#10;icon — String
    ///     &#10;Defines a name of an existing icon in the Kendo UI theme sprite. The icon will be applied as background image
    ///     of a span element inside the Button.
    ///     &#10;The span element can be added automatically by the widget, or an existing element can be used, if it has a
    ///     k-icon CSS class applied.
    ...
    ///     In case it is relative, it will be evaluated with relation to the web page URL.The img element can be added
    ///     automatically by the widget, or an existing element can be used, if it has a k-image CSS class applied.
    ///     &#10;
    ///     &#10;spriteCssClass — String
    ///     &#10;Defines a CSS class (or multiple classes separated by spaces), which will be used for applying a background
    ///     image to a span element inside the Button.
    ///     &#10;In case you want to use an icon from the Kendo UI theme sprite background image, it is easier to use the icon
    ///     property.The span element can be added automatically by the widget, or an existing element can be used, if it has a
    ///     k-sprite CSS class applied.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.ui.Calendar.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Calendar for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.ui.ColorPalette.prototype = {
    value: function(color) {
        /// <summary>
        ///     Get or set the selected color. If no argument is given, this returns the currently selected color as a string in
        ///     format #FFFFFF.If one argument is given, it selects the new color and updates the UI. The argument can be a string
        ///     in hex, rgb or rgba format, or a kendo.Color object object.
        /// </summary>
    ...
    enable: function(enable) {
        ...
        /// </summary>
        /// <param name="enable" type="Boolean">
        ///     Whether the widget should be enabled (true) or disabled (false). If not specified,
        ///     the method will enable the widget.
        /// </param>
    },
...
$.fn.kendoColorPalette = function(options) {
    ...
    ///     &#10;It can be a string with comma-separated colors in hex representation, an array of kendo.Color object objects
    ///     or of strings that parseColor understands.  As a shortcut, you can pass "basic" to get the simple palette (this is
    ///     the default) or "websafe" to get the Web-safe palette.
    ///     &#10;
...
kendo.ui.ColorPicker.prototype = {
    ...
    value: function(color) {
        ...
        ///     option is off, or rgba(255, 255, 255, 1) when opacity is requested.If one argument is given, it selects the new
        ///     color and updates the UI.  The
...
$.fn.kendoColorPicker = function(options) {
    ...
    ///     &#10;Specifies whether the widget should display the Apply / Cancel buttons.Applicable only for the HSV selector,
    ///     when a pallete is not specified.
    ///     &#10;
    ///     &#10;columns — Number
    ...
    ///     &#10;a simple color picker that lists the colors. The following are supported:If palette is missing or null, the
    ///     widget will display the HSV
    ///     &#10;selector.
    ///     &#10;
    ...
    ///     &#10;Only applicable for the HSV selector.Displays the color preview element, along with an input field where the
    ///     end user can paste a color in a CSS-supported notation.
    ///     &#10;
    ...
    ///     &#10;Note that when initializing the widget from an  element, the initial color will be decided by the field
    ///     instead.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
...
kendo.ui.ComboBox.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ComboBox for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    select: function(li) {
        ...
        /// </summary>
        /// <param name="li" type="Object">
        ///     A string, DOM element or jQuery object which represents the item to be selected. A
        ///     string is treated as a jQuery selector. A number representing the index of the item or function predicate which
        ///     returns the correct data item.
        /// </param>
        /// <returns type="Number">
        ///     The index of the selected item, if called with no parameters. If a custom value is entered, the
        ///     returned selected index is -1. If called with a parameter as a setter.
        /// </returns>
    },
...
$.fn.kendoComboBox = function(options) {
    ...
    ///     &#10;Defines the field to be used to filter the data source. If not defiend the parent's dataValueField option will
    ///     be used.
    ///     &#10;Help topic showing how cascading functionality works
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used to display a list of values. Can be a JavaScript object which
    ///     represents a valid data source configuration, a JavaScript array or an existing kendo.data.DataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;dataTextField — String (default: "")
    ///     &#10;The field of the data item that provides the text content of the list items. The widget will filter the data
    ///     source based on this field.
    ///     &#10;
    ...
    ///     &#10;The filtering method used to determine the suggestions for the current value. Filtration is turned of by
    ///     default.
    ...
    ///     &#10;
    ///     &#10;template — String|Function
    ///     &#10;The template used to render the items. By default the widget displays only the text of the data item
    ///     (configured via dataTextField).
    ///     &#10;
    ///     &#10;text — String (default: "")
    ...
    ///     &#10;
    ///     &#10;valuePrimitive — Boolean (default: false)
    ///     &#10;Specifies the value binding behavior for the widget when the initial model value is null. If set to true, the
    ///     View-Model field will be updated with the selected item value field. If set to false, the View-Model field will be
    ///     updated with the selected item.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
...
kendo.ui.DatePicker.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the DatePicker for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    readonly: function(readonly) {
        ...
        /// </summary>
        /// <param name="readonly" type="Boolean">
        ///     The argument, which defines whether the datepicker should be readonly or
        ///     editable.
        /// </param>
    },
    ...
    setOptions: function(options) {
        /// <summary>
        ///     Changes the initial DatePicker configuration. Will be included in Q3 2013 SP1. Currently available in Q3 2013
...
$.fn.kendoDatePicker = function(options) {
    ...
    ///     &#10;
    ///     &#10;animation — Object
    ///     &#10;Configures the opening and closing animations of the calendar popup. Setting the animation option to false
    ...
    ///     &#10;
    ///     &#10;parseFormats — Array
    ///     &#10;Specifies a lis of date formats used to parse the value set with value() method or by direct user input. If
    ///     not set the value of the format will be used.
...
kendo.ui.DateTimePicker.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the DateTimePicker for safe removal from DOM. Detaches all event handlers and removes jQuery.data
    ...
    readonly: function(readonly) {
        ...
        /// </summary>
        /// <param name="readonly" type="Boolean">
        ///     The argument, which defines whether the datetimepicker should be readonly or
        ///     editable.
        /// </param>
    },
    ...
    max: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Object">
        ///     The maximum time value to set for a DateTimePicker, expressed as a Date object or as
        ///     a string.
        /// </param>
    ...
    min: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Object">
        ///     The minimum time value to set for a DateTimePicker, expressed as a Date object or as
        ///     a string.
        /// </param>
...
$.fn.kendoDateTimePicker = function(options) {
    ...
    ///     &#10;
    ///     &#10;animation — Object
    ///     &#10;Configures the opening and closing animations of the popups. Setting the animation option to false will
    ///     disable the opening and closing animations. As a result the popup will open and close instantly.
    ///     &#10;
    ...
    ///     the date portion of the selected date will be used to re-bind the TimeView.
    ///     &#10;
    ///     &#10;depth — String
...
kendo.ui.Draggable.prototype = {
    cancelHold: function() {
        /// <summary>
        ///     Has effect only when holdToDrag is set to true. Cancels the activated state of the widget, caused by pressing and
        ///     holding.
        /// </summary>
    },
...
$.fn.kendoDraggable = function(options) {
    ...
    ///     &#10;Suitable for touch oriented user interface, in order to avoid collision with the touch scrolling gesture. When
    ///     set to true, the widget will be activated after the user taps and holds the finger on the element for a short
    ///     amount of time.The draggable will also be activated by pressing, holding and lifting the finger without any
    ///     movement. Dragging it afterwards will initiate the drag immediately. The activated mode can be canceled by calling
    ///     cancelHold.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
...
kendo.ui.DropDownList.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the DropDownList for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    select: function(li) {
        /// <summary>
        ///     Gets or sets the selected item. Selects the item provided as an argument and updates the value and text of the
        ///     widget.
        /// </summary>
        /// <param name="li" type="Object">
        ///     A string, DOM element or jQuery object which represents the item to be selected. A
    ...
    value: function(value) {
        /// <summary>
        ///     Gets or sets the value of the dropdownlist. The value will not be set if there is no item with such value. If value
        ///     is undefined, text of the data item is used.
        /// </summary>
        /// <param name="value" type="String">The value to set.</param>
...
$.fn.kendoDropDownList = function(options) {
    ...
    ///     &#10;Define the text of the default empty item. If the value is an object, then the widget will use it a valid data
    ///     item.
    ...
    ///     &#10;The valueTemplate used to render the selected value. By default the widget displays only the text of the data
...
$.fn.kendoDropTargetArea = function(options) {
    ...
    ///     &#10;Selector to filter the drop targets in the area. Every matched element acts as a drop target and fires events
    ///     on the DropTargetArea. Specifying the filter is mandatory.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.ui.Editor.prototype = {
    createRange: function(document) {
        ...
        ///     The document that the range is associated with. If omitted, the document of the
...
kendo.ui.Grid.prototype = {
    addRow: function() {
        /// <summary>
        ///     Adds an empty data item to the grid. In "incell" and "inline" editing mode a table row will be appended. Popup
        ///     window will be displayed in "popup" editing mode.Fires the edit event.
        /// </summary>
    },
    ...
    cellIndex: function(cell) {
        ...
        ///     A string, DOM element or jQuery object which represents the table cell. A string is
        ///     treated as a jQuery selector.
        /// </param>
    ...
    closeCell: function(isCancel) {
        ...
        /// </summary>
        /// <param name="isCancel" type="Boolean">
        ///     A flag specifying whether to fire the cancel event. By default the event is not
        ///     fired.
        /// </param>
    },
    ...
    collapseGroup: function(row) {
        ...
        ///     A string, DOM element or jQuery object which represents the group table row. A string
        ///     is treated as a jQuery selector.
        /// </param>
    },
    ...
    collapseRow: function(row) {
        ...
        /// </summary>
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the master table row. A string
        ///     is treated as a jQuery selector.
        /// </param>
    },
    ...
    dataItem: function(row) {
        ...
        /// </summary>
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the table row. A string is
        ///     treated as a jQuery selector.
        /// </param>
        /// <returns type="kendo.data.ObservableObject">
        ///     the data item to which the specified table row is bound. More information
        ///     about the ObservableObject type...
        /// </returns>
    },
    ...
    expandGroup: function(row) {
        ...
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the group table row. A string
        ///     is treated as a jQuery selector. Expands specified group.
        /// </param>
    },
    ...
    expandRow: function(row) {
        ...
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the master table row. A string
        ///     is treated as a jQuery selector. Expands specified master row.
        /// </param>
    },
    ...
    removeRow: function(row) {
        /// <summary>
        ///     Removes the specified table row from the grid. Also removes the corresponding data item from the data source.Fires
        ///     the remove event.
        /// </summary>
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the table row. A string is
    ...
    reorderColumn: function(destIndex, column) {
        ...
        /// </summary>
        /// <param name="destIndex" type="Number">
        ///     The new position of the column. The destination index should be calculated with
        ///     regard to all columns, including the hidden ones.
        /// </param>
    ...
    select: function(rows) {
        ...
        ///     A string, DOM element or jQuery object which represents the table row(s) or cell(s). A
        ///     string is treated as a jQuery selector.
        /// </param>
...
$.fn.kendoGrid = function(options) {
    ...
    ///     &#10;The template which renders the alternating table rows. Be default the grid renders a table row () for every
    ///     data source item.
    ///     &#10;
    ///     &#10;autoBind — Boolean (default: true)
    ///     &#10;If set to false the widget will not bind to the data source during initialization. In this case data binding
    ...
    ///     &#10;
    ///     &#10;columns — Array
    ///     &#10;The configuration of the grid columns. An array of JavaScript objects or strings. A JavaScript objects are
    ///     interpreted as column configurations. Strings are interpreted as the
    ...
    ///     &#10;If set to true the grid will display the column menu when the user clicks the chevron icon in the column
    ///     headers. The column menu allows the user to show and hide columns, filter and sort (if filtering and sorting are
    ///     enabled).
    ///     &#10;By default the column menu is not enabled.Can be set to a JavaScript object which represents the column menu
    ///     configuration.
    ///     &#10;
    ///     &#10;columnMenu — Object
    ///     &#10;If set to true the grid will display the column menu when the user clicks the chevron icon in the column
    ...
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used render table rows. Can be a JavaScript object which represents a
    ///     valid data source configuration, a JavaScript array or an existing kendo.data.DataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ...
    ///     &#10;If set to true the user would be able to edit the data to which the grid is bound to. By default editing is
    ///     disabled.Can be set to a string ("inline", "incell" or "popup") to specify the editing mode. The default editing
    ///     mode is "incell".Can be set to a JavaScript object which represents the editing configuration.
    ///     &#10;
    ///     &#10;editable — Object
    ///     &#10;If set to true the user would be able to edit the data to which the grid is bound to. By default editing is
    ///     disabled.Can be set to a string ("inline", "incell" or "popup") to specify the editing mode. The default editing
    ...
    ///     &#10;
    ///     &#10;filterable — Boolean (default: false)
    ///     &#10;If set to true the user can filter the data source using the grid filter menu. Filtering is disabled by
    ///     default.Can be set to a JavaScript object which represents the filter menu configuration.
    ///     &#10;
    ///     &#10;filterable — Object
    ///     &#10;If set to true the user can filter the data source using the grid filter menu. Filtering is disabled by
    ///     default.Can be set to a JavaScript object which represents the filter menu configuration.
    ...
    ///     &#10;If set to true the user could group the grid by dragging the column header cells. By default grouping is
    ///     disabled.Can be set to a JavaScript object which represents the grouping configuration.
    ///     &#10;
    ///     &#10;groupable — Object
    ///     &#10;If set to true the user could group the grid by dragging the column header cells. By default grouping is
    ///     disabled.Can be set to a JavaScript object which represents the grouping configuration.
    ...
    ///     &#10;If set to true the use could navigate the widget using the keyboard navigation. By default keyboard navigation
    ///     is disabled.
    ///     &#10;
    ///     &#10;pageable — Boolean (default: false)
    ///     &#10;If set to true the grid will display a pager. By default paging is disabled.Can be set to a JavaScript object
    ///     which represents the pager configuration.
    ///     &#10;
    ///     &#10;pageable — Object
    ///     &#10;If set to true the grid will display a pager. By default paging is disabled.Can be set to a JavaScript object
    ///     which represents the pager configuration.
    ...
    ///     &#10;If set to true the user could reorder the columns by dragging their header cells. By default reordering is
    ///     disabled.
    ///     &#10;
    ///     &#10;resizable — Boolean (default: false)
    ///     &#10;If set to true the user could resize the columns by dragging the edges of their header cells. By default
    ...
    ///     &#10;If set to true the grid will display a scrollbar when the total row height (or width) exceeds the grid height
    ///     (or width). By default scrolling is enabled.Can be set to a JavaScript object which represents the scrolling
    ///     configuration.
    ///     &#10;
    ///     &#10;scrollable — Object
    ///     &#10;If set to true the grid will display a scrollbar when the total row height (or width) exceeds the grid height
    ...
    ///     &#10;If set to true the user would be able to select grid rows. By default selection is disabled.Can also be set to
    ///     the following string values:
    ///     &#10;
    ///     &#10;sortable — Boolean (default: false)
    ///     &#10;If set to true the user could sort the grid by clicking the column header cells. By default sorting is
    ///     disabled.Can be set to a JavaScript object which represents the sorting configuration.
    ///     &#10;
    ///     &#10;sortable — Object
    ///     &#10;If set to true the user could sort the grid by clicking the column header cells. By default sorting is
    ///     disabled.Can be set to a JavaScript object which represents the sorting configuration.
    ///     &#10;
    ///     &#10;toolbar — Array
    ///     &#10;The list of commands displayed in the grid toolbar. Commands can be custom or built-in ("cancel", "create",
    ///     "save").The "cancel" built-in command reverts any data changes done by the end user.The "create" command adds an
    ///     empty data item to the grid.The "save" command persists any data changes done by the end user.
    ///     &#10;
    ///     &#10;mobile — Boolean|String (default: false)
    ///     &#10;If set to true and the grid is viewed on mobile browser it will use adaptive rendering.Can be set to a string
    ///     phone or tablet which will force the widget to use adaptive rendering regardless of browser type.
...
kendo.ui.ListView.prototype = {
    ...
    save: function() {
        /// <summary>
        ///     Saves edited ListView item. Triggers save event. If save event is not prevented and validation succeeds will call
        ///     DataSource sync method.
        /// </summary>
    },
...
kendo.ui.MaskedTextBox.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the MaskedTextBox for safe removal from DOM. Detaches all event handlers and removes jQuery.data
...
kendo.ui.Menu.prototype = {
    append: function(item, referenceItem) {
        ...
        /// </summary>
        /// <param name="item" type="Object">
        ///     Item to be appended, specified as a JSON object. An array of objects can also be
        ///     passed.
        /// </param>
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Menu for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMenu = function(options) {
    ...
    ///     animations in the widget.Available animations for the Menu are listed below.  Each animation has a reverse options
    ///     which is used for the close effect by default, but can be over-ridden
    ///     &#10;by setting the close animation.  Each animation also has a direction which can be set off the animation (i.e.
    ///     slideIn:Down).
    ///     &#10;
    ...
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used to render its items. Can be a JSON object/Array that contains an
    ///     item or an Array of items to be rendered.
...
kendo.ui.MultiSelect.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the MultiSelect for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoMultiSelect = function(options) {
    ...
    ///     &#10;
    ///     &#10;valuePrimitive — Boolean (default: false)
    ///     &#10;Specifies the value binding behavior for the widget. If set to true, the View-Model field will be updated with
    ///     the selected item value field. If set to false, the View-Model field will be updated with the selected item.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.ui.Notification.prototype = {
    ...
    getNotifications: function() {
        /// <summary>
        ///     Returns a jQuery collection of all visible notifications, displayed by the given widget instance. Each item in the
        ///     collection is a div.k-notification element.
        /// </summary>
    },
    ...
    show: function(data, type) {
        ...
        ///     Required. The string content for the notification; or the object with the values for
        ///     the variables inside the notification template; or the function, which returns the required string or an object.
        /// </param>
        /// <param name="type" type="String">
        ///     The notification type. Built-in types include "info", "success", "warning" and
        ///     "error". Custom types should match the types from the template configuration. If this argument is not supplied,
...
$.fn.kendoNotification = function(options) {
    ...
    ///     &#10;Defines custom show and hide animations via an Kendo UI Animation object. Setting the value to false disables
    ///     animations.
    ///     &#10;
    ///     &#10;appendTo — String (default: null)
    ///     &#10;Defines the element to which the notifications will be appended or prepended (depending on the stacking
    ///     direction).
    ///     &#10;
    ///     &#10;autoHideAfter — Number (default: 5000)
    ///     &#10;Indicates the period in milliseconds after which a notification disappears automatically. Setting a zero value
    ///     disables this behavior.
    ///     &#10;
    ///     &#10;button — Boolean (default: false)
    ///     &#10;Determines whether the notifications will include a hide button. This setting works with the built-in
    ///     templates only.
    ///     &#10;
    ...
    ///     &#10;It determines the position of the first notification on the screen, as well as whether the notifications will
    ///     move together with the page content during scrolling.
    ...
    ///     &#10;The "default" setting takes into consideration the applied position settings and is evaluated to "up" or
    ///     "down".
    ///     &#10;
    ///     &#10;templates — Array
    ///     &#10;Describes the HTML markup of the different notification types as Kendo UI template strings. The built-in types
    ///     are "info", "success", "warning" and "error".This documentation section assumes that you are familiar with Kendo UI
    ///     templates.
    ///     &#10;
...
kendo.ui.NumericTextBox.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the NumericTextBox for safe removal from DOM. Detaches all event handlers and removes jQuery.data
        ///     attributes to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.ui.Pager.prototype = {
    ...
    refresh: function() {
        /// <summary>
        ///     Updates all values of pager elements so that these values fit the values of DataSource. This method is
        ///     automatically called after DataSource change event is fired.
        /// </summary>
    },
...
$.fn.kendoPager = function(options) {
    ...
    ///     &#10;
    ///     &#10;dataSource — Object
    ///     &#10;Instance of kendo DataSource. See the kendo.data.DataSource.This option is mandatory because the Pager is
    ///     tightly connected with DataSource. The pager is UI widget for managing paging over the DataSource. The Pager gets
    ///     values like page size or total count of items from DataSource.
    ///     &#10;
    ...
    ///     option is provided for DataSource then this pageSize value will be automatically selected in created selectbox.
    ///     &#10;
...
kendo.ui.PanelBar.prototype = {
    ...
    collapse: function(element, useAnimation) {
        ...
        ///     expression or represented by a jQuery selector.
        /// </param>
        /// <param name="useAnimation" type="Boolean">
        ///     _optional, default: _Temporarily enables (true) or disables (false) any
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the PanelBar for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    enable: function(element, enable) {
        ...
        ///     string containing a selector expression or represented by a jQuery selector.
        /// </param>
    ...
    insertAfter: function(item, referenceItem) {
        ...
        /// </summary>
        /// <param name="item" type="Object">
        ///     Target item, specified as a JSON object. You can pass item text, content or contentUrl
    ...
    insertBefore: function(item, referenceItem) {
        ...
        /// <param name="item" type="Object">
        ///     Target item, specified as a JSON object. You can pass item text, content or contentUrl
        ///     here. Can handle an TML string or array of such strings or JSON.
        /// </param>
        /// <param name="referenceItem" type="Object">A reference item to insert the new item before.</param>
        /// <returns type="kendo.ui.PanelBar">Returns the PanelBar object to support chaining.</returns>
    },
    ...
    remove: function(element) {
        ...
        /// </summary>
        /// <param name="element" type="Object">
        ///     The PanelBar item(s) to be removed, expressed as a selector string, DOM element or
        ///     a jQuery object.
        /// </param>
    },
    ...
    select: function(element) {
        ...
        /// </summary>
        /// <param name="element" type="Object">
        ///     The PanelBar item to be selected, expressed as a string containing a selector
        ///     expression or represented by a jQuery selector.
        /// </param>
    },
...
$.fn.kendoPanelBar = function(options) {
    ...
    ///     &#10;
    ///     &#10;contentUrls — Array
    ///     &#10;Sets an array with the URLs from which the PanelBar items content to be loaded from. If only specific items
    ///     should be loaded via Ajax, then you should set the URLs to the corresponding positions in the array and set the
    ///     other elements to null.
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used to render its items. Can be a JSON object/Array that contains an
    ///     item or an Array of items to be rendered.
...
kendo.ui.ProgressBar.prototype = {
    enable: function(enable) {
        ...
        /// </summary>
        /// <param name="enable" type="Boolean">
        ///     The argument, which defines whether to enable/disable the ProgressBar. If no
        ///     argument is passed, the widget will be enabled.
        /// </param>
    },
    ...
    value: function(value) {
        /// <summary>
        ///     Gets or sets the value of the ProgressBar. It accepts a number, a string or false as a parameter. Setting the value
        ///     to false will set the state of the ProgressBar to indeterminate. If no parameter is passed, it returns the
        ///     underlying value.
        /// </summary>
...
$.fn.kendoProgressBar = function(options) {
    ...
    ///     &#10;
    ///     &#10;enable — Boolean (default: true)
    ///     &#10;If set to false the widget will be disabled. It will still allow changing the value. The widget is enabled by
    ///     default.
    ///     &#10;
...
kendo.ui.RangeSlider.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the RangeSlider for safe removal from the DOM.Detaches event handlers and removes data entries in order to
        ///     avoid memory leaks.
        /// </summary>
    },
...
kendo.ui.Scheduler.prototype = {
    ...
    editEvent: function(event) {
        ...
        ///     The event which should be put in edit mode. Also accepts a string which is the uid of
        ///     the event which should be edited.
        /// </param>
    },
    ...
    occurrenceByUid: function(uid) {
        ...
        /// <returns type="kendo.data.SchedulerEvent">
        ///     the occurrence instance. Returns undefined if an occurrence with the
        ///     specified uid is not found.
        /// </returns>
    },
    ...
    removeEvent: function(event) {
        ...
        /// </summary>
        /// <param name="event" type="Object">
        ///     The event which should be removed. Also accepts a string which is the uid of the
        ///     event which should be removed.
        /// </param>
    },
...
$.fn.kendoScheduler = function(options) {
    ...
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which contains the scheduler events. Can be a JavaScript object which represents
    ///     a valid data source configuration, a JavaScript array or an existing kendo.data.SchedulerDataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.SchedulerDataSource instance using that value as data source configuration.If the dataSource option is
    ///     an existing kendo.data.SchedulerDataSource instance the widget will use that instance and will not initialize a new
    ///     one.
    ///     &#10;
    ///     &#10;date — Date
    ...
    ///     &#10;The template used to render the date header cells.By default the scheduler renders the date using the current
    ///     culture date format.The fields which can be used in the template are:
    ///     &#10;
    ...
    ///     &#10;The template used to render the major ticks.By default the scheduler renders the time using the current
    ///     culture time format.The fields which can be used in the template are:
    ///     &#10;
    ...
    ///     &#10;The template used to render the minor ticks.By default the scheduler renders a "&nbsp;".The fields which can
    ///     be used in the template are:
    ///     &#10;
    ///     &#10;mobile — Boolean|String (default: false)
    ///     &#10;If set to true and the scheduler is viewed on mobile browser it will use adaptive rendering.Can be set to a
    ///     string phone or tablet which will force the widget to use adaptive rendering regardless of browser type.
    ///     &#10;
    ///     &#10;resources — Array
    ///     &#10;The configuration of the scheduler resource(s). A scheduler resource is optional metadata that can be
    ///     associated
    ...
    ///     &#10;If set to true the view will be initially shown in business hours mode. By default view is displyed in full
    ///     day mode.
    ///     &#10;
    ///     &#10;snap — Boolean (default: true)
    ///     &#10;If set to true the scheduler will snap events to the nearest slot during dragging (resizing or moving). Set it
    ///     to false to allow free moving and resizing of events.
    ///     &#10;
    ///     &#10;startTime — Date
    ///     &#10;The start time of the week and day views. The scheduler will display events starting after the startTime.
    ///     &#10;
    ///     &#10;timezone — String
    ///     &#10;The timezone which the scheduler will use to display the scheduler appointment dates. By default the current
    ///     system timezone is used. This is an acceptable default when the
    ///     &#10;scheduler widget is bound to local array of events. It is advisable to specify a timezone if the scheduler is
    ///     bound to a remote service.
    ///     &#10;That way all users would see the same dates and times no matter their configured system timezone.The complete
    ///     list of the supported timezones is available in the List of IANA time zones Wikipedia page.
    ///     &#10;
    ///     &#10;views — Array
    ///     &#10;The views displayed by the scheduler and their configuration. The array items can be either objects specifying
    ///     the view configuration or strings representing the view types (assuming default configuration).
...
$.fn.kendoSortable = function(options) {
    ...
    ///     &#10;Selector which determines if items from the current Sortable widget can be accepted from another Sortable
    ///     container(s). The connectWith option describes one way relationship, if the developer wants a two way connection
    ///     then the connectWith option should be set on both widgets.
    ///     &#10;
    ...
    ///     &#10;Selector that determines which items are disabled. Disabled items cannot be dragged but are valid sort
    ///     targets.
    ///     &#10;
    ///     &#10;filter — String (default: null)
    ///     &#10;Selector that determines which items are sortable. Filtered items cannot be dragged and are not valid sort
    ///     targets.
    ///     &#10;
    ///     &#10;handler — String (default: null)
    ///     &#10;Selector that determines which element will be used as a draggable handler. If a handler is defined, the user
    ///     will be able to move the Sortable items only if the cursor/finger is positioned onto the handler element.
    ///     &#10;
    ///     &#10;hint — Function|String
    ///     &#10;Provides a way for customization of the sortable item hint. If a function is supplied, it receives one
    ///     argument - the draggable element's jQuery object.
    ///     &#10;If hint function is not provided the widget will clone dragged item and use it as a hint.
    ///     &#10;
    ///     &#10;holdToDrag — Boolean (default: false)
    ///     &#10;Suitable for touch oriented user interface, in order to avoid collision with the touch scrolling gesture. When
    ///     set to true, the item will be activated after the user taps and holds the finger on the element for a short amount
    ///     of time.
    ///     &#10;The item will also be activated by pressing, holding and lifting the finger without any movement. Dragging it
    ///     afterwards will initiate the drag immediately.
    ///     &#10;
    ///     &#10;placeholder — Function|String
    ///     &#10;Provides a way for customization of the sortable item placeholder. If a function is supplied, it receives one
    ///     argument - the draggable element's jQuery object.
    ///     &#10;If placeholder function is not provided the widget will clone dragged item, remove its ID attribute, set its
    ///     visibility to hidden and use it as a placeholder.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
kendo.ui.Splitter.prototype = {
    ...
    append: function(config) {
        /// <summary>
        ///     Appends a new pane. The method returns the pane element, so it can be populated with arbitrary content, if
        ///     contentUrl is not set.
    ...
    collapse: function(pane) {
        /// <summary>
        ///     Collapses a specified pane. Invoking this method will force the widget to redraw and it will trigger the resize
        ///     event.
    ...
    expand: function(pane) {
        /// <summary>
        ///     Expands a specified pane. Invoking this method will force the widget to redraw and it will trigger the resize
        ///     event.
    ...
    insertAfter: function(config, referencePane) {
        /// <summary>
        ///     Inserts a new pane after the specified one. The method returns the pane element, so it can be populated with
        ///     arbitrary content, if contentUrl is not set.
        ///     Invoking this method will force the widget to redraw and it will trigger the resize event.
        /// </summary>
        /// <param name="config" type="Object">The new pane configuration.</param>
    ...
    insertBefore: function(config, referencePane) {
        /// <summary>
        ///     Inserts a new pane before the specified one. The method returns the pane element, so it can be populated with
        ///     arbitrary content, if contentUrl is not set.
        ///     Invoking this method will force the widget to redraw and it will trigger the resize event.
        /// </summary>
        /// <param name="config" type="Object">The new pane configuration.</param>
    ...
    max: function(pane, value) {
        /// <summary>
        ///     Sets the maximum size of a pane. Setting this value will not cause the widget to redraw, nor will it trigger any
        ///     events.
        /// </summary>
    ...
    min: function(pane, value) {
        /// <summary>
        ///     Sets the minimum size of a pane. Setting this value will not cause the widget to redraw, nor will it trigger any
        ///     events.
        /// </summary>
        /// <param name="pane" type="Object">The pane being targeted for a new minimum size configuration value.</param>
        /// <param name="value" type="String">
    ...
    toggle: function(pane, expand) {
        ...
        ///     Represents the desired state of the specified pane; to be expanded (true) or
        ///     collapsed (false). If undefined, toggle() will collapse the pane if it is expanded or will expand the pane if it is
        ///     collapsed.
        /// </param>
    },
...
kendo.ui.TabStrip.prototype = {
    ...
    contentHolder: function(itemIndex) {
        ...
        ///     holds the content, which on mobile is the scroll container.
        /// </summary>
        /// <param name="itemIndex" type="Number">The index of the tab in the TabStrip.</param>
    ...
    reload: function(element) {
        ...
        /// </summary>
        /// <param name="element" type="Object">
        ///     The target tab(s), specified as a selector or jQuery object, to be reloaded via
        ///     AJAX.
        /// </param>
        /// <returns type="kendo.ui.TabStrip">Returns the TabStrip object to support chaining.</returns>
    },
    ...
    select: function(element) {
        ...
        /// </summary>
        /// <param name="element" type="Object">
        ///     The target tab(s), specified as a selector, jQuery object or index in the tab
        ///     group.
        /// </param>
...
$.fn.kendoTabStrip = function(options) {
    ...
    ///     &#10;
    ///     &#10;contentUrls — Array
    ///     &#10;Sets an array with the URLs from which the tabs content to be loaded from. If only specific tabs should be
    ///     loaded via Ajax, then you should set the URLs to the corresponding positions in the array and set the other
    ///     elements to null.
    ///     &#10;
...
kendo.ui.TimePicker.prototype = {
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the TimePicker for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    readonly: function(readonly) {
        ...
        /// </summary>
        /// <param name="readonly" type="Boolean">
        ///     The argument, which defines whether the timepicker should be readonly or
        ///     editable.
        /// </param>
    },
    ...
    max: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Object">
        ///     The maximum time value to set for a TimePicker, expressed as a Date object or as a
        ///     string.
        /// </param>
    ...
    min: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Object">
        ///     The minimum time value to set for a TimePicker, expressed as a Date object or as a
        ///     string.
        /// </param>
    ...
    setOptions: function(options) {
        /// <summary>
        ///     Changes the initial TimePicker configuration. Will be included in Q3 2013 SP1. Currently available in Q3 2013
        ///     internal builds only.
        /// </summary>
        /// <param name="options" type="Object">The new configuration options.</param>
    },
...
$.fn.kendoTimePicker = function(options) {
    ...
    ///     &#10;
    ///     &#10;animation — Object
    ///     &#10;Configures the opening and closing animations of the popup. Setting the animation option to false will disable
    ///     the opening and closing animations. As a result the popup will open and close instantly.
    ///     &#10;
    ///     &#10;culture — String (default: "en-US")
    ///     &#10;Specifies the culture info used by the widget.
    ///     &#10;
    ///     &#10;dates — Array
    ///     &#10;Specifies a list of dates, which are shown in the time drop-down list. If not set, the TimePicker will
...
$.fn.kendoTooltip = function(options) {
    ...
    ///     &#10;Specifies if the tooltip will be hidden when mouse leaves the target element. If set to false a close button
    ///     will be shown within tooltip. If set to false, showAfter is specified and the showOn is set to "mouseenter" the
    ///     Tooltip will be displayed after the given timeout even if the element is no longer hovered.
    ///     &#10;
    ///     &#10;animation — Object
    ...
    ///     &#10;The position relative to the target element, at which the tooltip will be shown. Predefined values are
    ///     "bottom", "top", "left", "right", "center".
    ///     &#10;
    ///     &#10;showAfter — Number (default: 100)
    ///     &#10;Specify the delay in milliseconds before the tooltip is shown. This option is ignored if showOn is set to
    ///     "click" or "focus".
    ///     &#10;
...
kendo.ui.Touch.prototype = {
    cancel: function() {
        /// <summary>
        ///     Cancels the current touch event sequence. Calling cancel in a touchstart or dragmove will disable subsequent move
        ///     or tap/end/hold event handlers from being called.
        /// </summary>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the Touch for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
$.fn.kendoTouch = function(options) {
    ...
    ///     &#10;If set to true, the widget will capture and trigger the gesturestart, gesturechange, and gestureend events
    ///     when the user touches the element with two fingers.
    ///     &#10;
    ///     &#10;enableSwipe — Boolean (default: false)
    ///     &#10;If set to true, the Touch widget will recognize horizontal swipes and trigger the swipe event.Notice: if the
    ///     enableSwipe option is set to true, the dragstart, drag and dragend events will not be triggered.
    ///     &#10;
    ...
    ///     &#10;The timeout in milliseconds before the hold event is fired.Notice: the hold event will be triggered after the
    ///     time passes, not after the user lifts his/hers finger.
    ///     &#10;
...
kendo.ui.TreeView.prototype = {
    append: function(nodeData, parentNode, success) {
        ...
        ///     A JSON-formatted string or selector that specifies the node to be appended. If the
        ///     argument is a plain JavaScript object, a new item will be created. If the argument is a jQuery element that holds a
        ///     node, the treeview node will be moved. If the argument is an array of objects, each item of the array will be
        ///     appended.
        /// </param>
        /// <param name="parentNode" type="jQuery">
        ///     The node that will contain the newly appended node. If not specified, the new
        ///     node will be appended to the root group of the TreeView.
        /// </param>
        /// <param name="success" type="Function">
        ///     A success callback that will be called once the new node has been appended.
        ///     Useful in the case of remote binding where an item is appended to an unfetched node. The callback is called once
        ///     the siblings have been fetched.
        /// </param>
        /// <returns type="jQuery">
        ///     The inserted
        ///     <li> element, wrapped in a jQuery object,or null if the new model has not been inserted immediately.
        /// </returns>
    },
    ...
    dataItem: function(node) {
        ...
        ///     A string, DOM element or jQuery object which represents the node. A string is treated
    ...
    updateIndeterminate: function(node) {
        /// <summary>
        ///     Updates the indeterminate state of the treeview checkboxes. Should be used for better performance when checking
        ///     multiple checkboxes through code.
        /// </summary>
        /// <param name="node" type="jQuery">
        ///     Optional. The root of the hierarchy that will be looped through. Allows only a subtree
        ///     to be processed. The default value is the treeview root.
        /// </param>
    },
...
$.fn.kendoTreeView = function(options) {
    ...
    ///     &#10;
    ///     &#10;dataSource — Object|Array
    ///     &#10;The data source of the widget which is used render nodes. Can be a JavaScript object which represents a valid
    ///     data source configuration, a JavaScript array or an existing kendo.data.HierarchicalDataSource instance.If the
    ///     dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.HierarchicalDataSource instance using that value as data source configuration.If the dataSource option
    ///     is an existing kendo.data.HierarchicalDataSource instance the widget will use that instance and will not initialize
    ///     a new one.
    ///     &#10;
    ...
    ///     &#10;Note: when initializing the widget from an array (rather than from a HierarchicalDataSource instance), this
    ///     option defaults to false, rather than true.
    ///     &#10;
    ///     &#10;messages — Object
...
kendo.ui.Upload.prototype = {
    destroy: function() {
        /// <summary>
        ///     Prepares the Upload for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes to
        ///     avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
...
kendo.ui.Validator.prototype = {
    ...
    validate: function() {
        ...
        ///     true if all validation rules passed successfully.Note that if a HTML form element is set as
        ///     validation container, the form submits will be automatically prevented if validation fails.
        /// </returns>
    },
...
kendo.ui.Widget.prototype = {
    ...
    one: function() {
        /// <summary>
        ///     Attaches a handler to an event. The handler is executed only once. Examples and more info can be found in the one
        ///     section of the
        ///     kendo.Observable API reference.
        /// </summary>
    },
...
kendo.ui.Window.prototype = {
    ...
    content: function(content) {
        ...
        /// <returns type="kendo.ui.Window">
        ///     If the content parameter is provided, this method will return the widget object to
        ///     support chaining. Otherwise, it will return the current content of the widget.
        /// </returns>
    },
    ...
    pin: function() {
        /// <summary>
        ///     Pins the Window at its current position with a position:fixed style, i.e. the widget stops moving together with the
        ///     other page content when the page is scrolled.
    ...
    refresh: function(options) {
        ...
        ///     Note that passing data and non-GET requests cannot be sent to an iframe, as they require a form with a target
        ///     attribute.
        /// </summary>
    ...
    title: function(text) {
        ...
        /// <returns type="kendo.ui.Window">
        ///     If a title is provided, this method will return the window object to support chaining.
        ///     Otherwise, it will return the current title of the window.
        /// </returns>
    },
    ...
    unpin: function() {
        /// <summary>
        ///     Disables the Window's pinned state, so that the widget will move together with the other page content when the page
        ///     is scrolled.
        /// </summary>
    },
...
$.fn.kendoWindow = function(options) {
    ...
    ///     &#10;
    ///     &#10;content — String
    ///     &#10;Specifies a URL or request options that the window should load its content from.Note: For URLs starting with a
    ///     protocol (e.g. http://),
    ...
    ///     &#10;The text in the window title bar. If false, the window will be displayed without a title bar. Note that this
    ///     will prevent the window from being dragged, and the window titlebar buttons will not be shown.
    ///     &#10;
